<template>
  ...
  <div class="Detail">
    ...
    <div class="title">
      <div class="maintitle">{{detail.title}}</div>
      <div class="small">{{detail.second_title}}</div>
    </div>
    <div class="futxt" v-html="detail.content"></div>
      ...
      getDetail(){
        ...
        req.get('/travel_detail',{params: {
          ...
          .then(function (response) {
            ...
            for(let i=0;i<vm.detail.length;i++){
              vm.detail[i].image= "url("+vm.detail[i].image+")";
            }
            console.log('--------');
          })
